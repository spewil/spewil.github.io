...
<!-- - set the scene
- science fair lab as an experimental community
- rural ingenuity out of necessity
- rural areas have so much promise, as much talent as anywhere -->
...
<!-- Like many others, I'm interested in understanding how bubbles of innovation and disruption arise, and what kinds of tools factors can lead to their creation.  -->
...
<!-- Matt Clifford, Co-Founder of Entrepreneur First, has argued that focusing on funding companies with prior access to networks and resources, we're missing out on the promise that folks in other communities have-- the experience of high-impact problems for their communities.
 -->
...
<!--
- my family in particular is into cars-- not just for the nostalgic americana of the hot rod, but for the pride in passing down skills of the trade to keep a piece of design alive, to keep it moving.
- cars in particular embody the american ideal of independence, freedom, and goin' fast.
- this is my romantic idea of what rural communities can be-- just that, communities -->

<h2>pragmatic laboratories</h2>
<!--
- experimental schools are a good model
- pushing the idea of what a school can be, what a school is for
- push the idea of what a community, a town can be
- i argue that rural communities are especially equipped to look for creative solutions to their problems, to leverage the idiosyncrasies of their place into opportunities
-->

<!-- I believe incredible innovations can come from rural communities, but they are so often overlooked when we think about innovation in the Silicon Valley sense of the term. Rural communities offer an opportunity to explore new forms of the American democratic, energetic, and civic ideal. -->
...
<!-- voter turnout in Georgia in 2016 was 76.53% -->

<!-- colquitt 13,601 / 45000 x .60 == approximately 50% -->
...
<!-- NeighborWorks suggestions:
    Further leveraging of the CRA could, for instance, provide a significant opportunity to help close the digital divide across communities while simultaneously benefiting financial institutions and improving economic stability.
    Acknowledging that broadband internet connectivity now is considered a basic public utility such as telephone and electricity, federal agencies such as the U.S. Department of
     Housing and Urban Development have made access in the home a priority. When addressing the nature of a community’s digital divide, the “three legs of the stool” of broadband adoption should always be considered:
    1. Broadband access.
    2. Computer access.
    3. Training and technical assistance.
    Providing computers without broadband access, or providing internet and laptops without training in the skills to use them is not very useful. What is needed is a comprehensive, holistic approach, often at the regional level.
 -->
...
[Fahe](https://fahe.org/about-fahe/) is an organization committed to addressing persistent poverty in Appalachia through funding strategic financing programs such as community lending.

local credit unions? crack down on predatory lending?

The Community Reinvestment Act (1977)

## NeighborWorks America:

Nonprofit organization investing in rural infrastructure, housing, financial tools, and community organization towards bettering persistently impoverished rural communities.

"Turning the Tide of Persistant Rural Poverty" whitepaper
The U.S. Department of Agriculture’s Economic Research Service defines counties as persistently poor if 20 percent or more of the population has lived in poverty for the previous 30 years.
"Although rural America accounts for less than 20 percent of the country’s overall population, 86 percent of all persistent poverty counties in the United States are rural."
...
- Build and sustain consumer wealth, supported by educational initiatives, incentives, and social and community networks.
- Create jobs by removing barriers, encouraging entrepreneurial business start-ups and anticipating emerging economic engines
while reversing out-migration.
...
Over the past century in the United States and around the world, one of the most pervasive responses to rural poverty has been out-migration. Voting with their feet, workers leave behind low-paid rural, agricultural, resource-based or ser- vice jobs in search of higher-paid urban work. Young people in particular are going elsewhere in a quest to find better education and jobs. That has all sorts of consequences, including the ability to attract business, generate tax revenue and “scale up.” -->